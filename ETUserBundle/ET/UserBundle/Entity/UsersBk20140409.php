 ...
 * UsersBk20140409
 *
 * @ORM\Table(name="users_bk_20140409", uniqueConstraints={@ORM\UniqueConstraint(name="username", columns={"username"})}, indexes={@ORM\Index(name="iduser", columns={"iduser"}), @ORM\Index(name="status", columns={"status"}), @ORM\Index(name="ferie", columns={"ferie"})})
 * @ORM\Entity
 */
class UsersBk20140409
{
    /**
     * @var string
     *
     ...
     * @var string
     *
     * @ORM\Column(name="disp", type="string", length=100, nullable=false)
     */
    private $disp = '';
     ...
     * @var integer
     *
     * @ORM\Column(name="multiagenzia_id", type="integer", nullable=false)
     */
    private $multiagenziaId = '0';
