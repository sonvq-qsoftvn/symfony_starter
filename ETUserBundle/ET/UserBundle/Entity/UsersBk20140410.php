 ...
 * UsersBk20140410
 *
 * @ORM\Table(name="users_bk_2014_04_10", uniqueConstraints={@ORM\UniqueConstraint(name="username", columns={"username"})}, indexes={@ORM\Index(name="iduser", columns={"iduser"}), @ORM\Index(name="status", columns={"status"}), @ORM\Index(name="ferie", columns={"ferie"})})
 * @ORM\Entity
 */
