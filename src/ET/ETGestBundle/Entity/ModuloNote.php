 ...
 * ModuloNote
 *
 * @ORM\Table(name="modulo_note", indexes={@ORM\Index(name="id_viaggio", columns={"id_viaggio"}), @ORM\Index(name="data", columns={"data"}), @ORM\Index(name="booking_stato", columns={"booking_stato"}), @ORM\Index(name="ec_stato", columns={"ec_stato"}), @ORM\Index(name="tipoDocumento", columns={"tipoDocumento", "booking_stato"})})
 * @ORM\Entity
 */
class ModuloNote
{
