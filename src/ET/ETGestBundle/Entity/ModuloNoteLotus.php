 ...
 * ModuloNoteLotus
 *
 * @ORM\Table(name="modulo_note_lotus", indexes={@ORM\Index(name="id_viaggio", columns={"id_viaggio"}), @ORM\Index(name="tipoDocumento", columns={"tipoDocumento"}), @ORM\Index(name="data", columns={"data"}), @ORM\Index(name="booking_stato", columns={"booking_stato"})})
 * @ORM\Entity
 */
class ModuloNoteLotus
{
     ...
     * @var integer
     *
     * @ORM\Column(name="codPromotoreCreazione", type="smallint", nullable=false)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="codPromotoreModifica", type="smallint", nullable=false)
     */
