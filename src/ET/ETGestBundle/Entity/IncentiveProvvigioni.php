...
/**
 * IncentiveProvvigioni
 *
 * @ORM\Table(name="incentive_provvigioni", indexes={@ORM\Index(name="codPromotore", columns={"codPromotore"}), @ORM\Index(name="provigione", columns={"provvigione"}), @ORM\Index(name="id_viaggio", columns={"id_viaggio"}), @ORM\Index(name="id_modulo", columns={"id_modulo"}), @ORM\Index(name="data", columns={"data"}), @ORM\Index(name="agenzia", columns={"agenzia"})})
 * @ORM\Entity
 */
class IncentiveProvvigioni
{
    /**
     * @var integer
     *
