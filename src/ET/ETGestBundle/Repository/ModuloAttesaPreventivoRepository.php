...
/**
 * ModuloAttesaPreventivoRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class ModuloAttesaPreventivoRepository extends \Doctrine\ORM\EntityRepository
{
	public function findModuleByTravelIdAndDocumentType($id, $type)
	{
		...
		$qb->from('ETGestBundle:ModuloAttesaPreventivo', 'm');
