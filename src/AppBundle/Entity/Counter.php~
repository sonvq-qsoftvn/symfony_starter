...
class Counter
{
     ...
     * Set totaleassegnate
     *
     * @param integer $totaleassegnate
     *
     * @return Counter
     */
    public function setTotaleassegnate($totaleassegnate)
    {
        $this->totaleassegnate = $totaleassegnate;
     ...
     * @return integer
     */
    public function getTotaleassegnate()
    {
        return $this->totaleassegnate;
    }
     ...
     * Set collegato
     *
     * @param boolean $collegato
     *
     * @return Counter
     */
    public function setCollegato($collegato)
    {
