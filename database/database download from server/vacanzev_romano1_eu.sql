...
DROP TABLE IF EXISTS `backoffice_agencyfee`;
CREATE TABLE `backoffice_agencyfee` (
...
DROP TABLE IF EXISTS `backoffice_bannerHome`;
CREATE TABLE `backoffice_bannerHome` (
...
DROP TABLE IF EXISTS `backoffice_categorie`;
CREATE TABLE `backoffice_categorie` (
...
DROP TABLE IF EXISTS `backoffice_circolari`;
CREATE TABLE `backoffice_circolari` (
...
DROP TABLE IF EXISTS `backoffice_destinazioni`;
CREATE TABLE `backoffice_destinazioni` (
...
DROP VIEW IF EXISTS `backoffice_fornitori`;
CREATE TABLE `backoffice_fornitori` (`idFornitore` mediumint(8) unsigned, `ragione_sociale` varchar(255), `descrizione` varchar(255), `indirizzo` varchar(255), `cap` varchar(10), `citta` varchar(255), `provincia` varchar(100), `cod_stato` varchar(4), `piva` varchar(100), `cod_fiscale` varchar(100), `url` varchar(255), `fk_pagamento` mediumint(9), `aves` tinyint(1), `aves_risposta` text, `statoVerificato` tinyint(1), `assicurazioneObbligatoria` tinyint(1) unsigned, `parent` mediumint(8) unsigned, `note` text, `created_at` datetime, `updated_at` datetime, `deleted_at` datetime, `agenzia` varchar(10), `pre` char(0), `status` int(1), `tel1` varchar(255), `tel2` varchar(255), `fax` varchar(255), `email` varchar(255));


DROP TABLE IF EXISTS `backoffice_fornitori_agenzie`;
CREATE TABLE `backoffice_fornitori_agenzie` (
...
DROP TABLE IF EXISTS `backoffice_fornitori_agenzie_bk`;
CREATE TABLE `backoffice_fornitori_agenzie_bk` (
  `idFornitore` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `ragione_sociale` varchar(255) CHARACTER SET latin1 NOT NULL,
  `descrizione` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `indirizzo` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
...
DROP VIEW IF EXISTS `backoffice_fornitori_agenzie_contatti`;
CREATE TABLE `backoffice_fornitori_agenzie_contatti` (`idFornitore` mediumint(8) unsigned, `ragione_sociale` varchar(255), `descrizione` varchar(255), `indirizzo` varchar(255), `cap` varchar(10), `citta` varchar(255), `provincia` varchar(100), `cod_stato` varchar(4), `piva` varchar(100), `cod_fiscale` varchar(100), `url` varchar(255), `fk_pagamento` mediumint(9), `aves` tinyint(1), `aves_risposta` text, `statoVerificato` tinyint(1), `assicurazioneObbligatoria` tinyint(1) unsigned, `parent` mediumint(8) unsigned, `note` text, `created_at` datetime, `updated_at` datetime, `deleted_at` datetime, `agenzia` varchar(10), `pre` char(0), `status` int(1), `tel1` varchar(255), `tel2` varchar(255), `fax` varchar(255), `email` varchar(255));


DROP TABLE IF EXISTS `backoffice_fornitori_contatti`;
CREATE TABLE `backoffice_fornitori_contatti` (
...
DROP TABLE IF EXISTS `backoffice_fornitori_import`;
CREATE TABLE `backoffice_fornitori_import` (
...
DROP TABLE IF EXISTS `backoffice_fornitori_old`;
CREATE TABLE `backoffice_fornitori_old` (
...
DROP TABLE IF EXISTS `backoffice_fornitori_rel_port`;
CREATE TABLE `backoffice_fornitori_rel_port` (
...
DROP TABLE IF EXISTS `backoffice_news`;
CREATE TABLE `backoffice_news` (
...
DROP VIEW IF EXISTS `backoffice_pagamenti`;
CREATE TABLE `backoffice_pagamenti` (`id_pagamento` int(3), `cod` varchar(64), `descrizione` varchar(255), `agenzia` varchar(10));


DROP TABLE IF EXISTS `backoffice_pagamenti_agenzie`;
CREATE TABLE `backoffice_pagamenti_agenzie` (
...
DROP VIEW IF EXISTS `backoffice_portali`;
CREATE TABLE `backoffice_portali` (`idPortale` smallint(4) unsigned, `nomePortale` varchar(200), `fcd` varchar(30), `tempo_accettazione` int(11) unsigned, `tempo_lavorazione` int(11) unsigned, `attesa_preventivo` tinyint(1) unsigned, `attivo` tinyint(1), `visualizzato` tinyint(1) unsigned, `mercato` varchar(45));


DROP TABLE IF EXISTS `backoffice_portali_backup`;
CREATE TABLE `backoffice_portali_backup` (
...
DROP TABLE IF EXISTS `backoffice_portali_mercati`;
CREATE TABLE `backoffice_portali_mercati` (
  `idPortale` smallint(4) unsigned NOT NULL AUTO_INCREMENT,
  `nomePortale` varchar(200) NOT NULL DEFAULT '',
  `fcd` varchar(30) NOT NULL DEFAULT '',
  `tempo_accettazione` int(11) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `backoffice_provvigioni`;
CREATE TABLE `backoffice_provvigioni` (
...
DROP TABLE IF EXISTS `backoffice_servizi_dettagli`;
CREATE TABLE `backoffice_servizi_dettagli` (
...
DROP TABLE IF EXISTS `backoffice_sistemazioni`;
CREATE TABLE `backoffice_sistemazioni` (
...
DROP TABLE IF EXISTS `backoffice_sistemazioni_dettaglio`;
CREATE TABLE `backoffice_sistemazioni_dettaglio` (
...
DROP TABLE IF EXISTS `backoffice_strutture`;
CREATE TABLE `backoffice_strutture` (
...
DROP TABLE IF EXISTS `backoffice_to`;
CREATE TABLE `backoffice_to` (
...
DROP TABLE IF EXISTS `backoffice_to_rel_cat`;
CREATE TABLE `backoffice_to_rel_cat` (
...
DROP TABLE IF EXISTS `backoffice_to_rel_dest`;
CREATE TABLE `backoffice_to_rel_dest` (
...
DROP TABLE IF EXISTS `backoffice_to_rel_forn`;
CREATE TABLE `backoffice_to_rel_forn` (
  `idTo` int(6) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `backoffice_to_rel_prov`;
CREATE TABLE `backoffice_to_rel_prov` (
...
DROP TABLE IF EXISTS `backoffice_trattamenti`;
CREATE TABLE `backoffice_trattamenti` (
  `id` varchar(4) NOT NULL DEFAULT '',
  `descrizione` varchar(50) NOT NULL DEFAULT '',
  `descrizione_en` varchar(50) NOT NULL DEFAULT '',
  `descrizione_es` varchar(50) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `banner_prova`;
CREATE TABLE `banner_prova` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `nome` varchar(255) DEFAULT NULL,
  `width` int(10) DEFAULT NULL,
  `height` int(10) DEFAULT NULL,
...
DROP TABLE IF EXISTS `banner_vetrina1`;
CREATE TABLE `banner_vetrina1` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `banner_vetrina2`;
CREATE TABLE `banner_vetrina2` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `etichetta` varchar(20) NOT NULL DEFAULT '',
  `nomePortale` varchar(50) NOT NULL DEFAULT '',
  `urlPortale` varchar(150) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `etcontact`;
CREATE TABLE `etcontact` (
...
DROP TABLE IF EXISTS `luca_articoli`;
CREATE TABLE `luca_articoli` (
...
DROP TABLE IF EXISTS `luca_immagini`;
CREATE TABLE `luca_immagini` (
...
DROP TABLE IF EXISTS `offertebackup`;
CREATE TABLE `offertebackup` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `offertefax`;
CREATE TABLE `offertefax` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `destinazione` varchar(50) DEFAULT NULL,
  `data_partenza1` date DEFAULT NULL,
  `data_partenza2` date DEFAULT NULL,
...
DROP TABLE IF EXISTS `promuovi_struttura`;
CREATE TABLE `promuovi_struttura` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `redazione_prodotti`;
CREATE TABLE `redazione_prodotti` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `redazione_redazionali`;
CREATE TABLE `redazione_redazionali` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `redazione_struttura`;
CREATE TABLE `redazione_struttura` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `tourOperator_commissioni`;
CREATE TABLE `tourOperator_commissioni` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `tourOperator_iso`;
CREATE TABLE `tourOperator_iso` (
...
DROP TABLE IF EXISTS `tourOperator_portale`;
CREATE TABLE `tourOperator_portale` (
...
DROP TABLE IF EXISTS `tourOperator_rel_tag`;
CREATE TABLE `tourOperator_rel_tag` (
...
DROP TABLE IF EXISTS `tourOperator_tag`;
CREATE TABLE `tourOperator_tag` (
