...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2016 at 09:29 AM
...
--
-- Database: `vacanzev_etticket`
--

-- --------------------------------------------------------

--
-- Table structure for table `bk_request`
--

CREATE TABLE IF NOT EXISTS `bk_request` (
...
--
-- Table structure for table `clientconversation`
--

CREATE TABLE IF NOT EXISTS `clientconversation` (
...
--
-- Table structure for table `counter_20091030`
--

CREATE TABLE IF NOT EXISTS `counter_20091030` (
  `promotore_id` int(11) unsigned NOT NULL DEFAULT '0',
  `portale` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `lingua` varchar(10) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'it_IT',
  `totaleAssegnatoDirette` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `counter_20091105`
--

CREATE TABLE IF NOT EXISTS `counter_20091105` (
  `promotore_id` int(11) unsigned NOT NULL DEFAULT '0',
  `portale` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `lingua` varchar(10) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'it_IT',
  `totaleAssegnatoDirette` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `counter_adesso`
--

CREATE TABLE IF NOT EXISTS `counter_adesso` (
  `promotore_id` int(11) unsigned NOT NULL DEFAULT '0',
  `portale` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `lingua` varchar(10) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'it_IT',
  `totaleAssegnatoDirette` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `counter_ok`
--

CREATE TABLE IF NOT EXISTS `counter_ok` (
  `promotore_id` int(11) unsigned NOT NULL DEFAULT '0',
  `portale` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `lingua` varchar(10) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'it_IT',
  `totaleAssegnatoDirette` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `counter_orig`
--

CREATE TABLE IF NOT EXISTS `counter_orig` (
  `promotore_id` int(11) unsigned NOT NULL DEFAULT '0',
  `portale` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `lingua` varchar(10) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'it_IT',
  `totaleAssegnatoDirette` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `et_portali_prodotti`
--

CREATE TABLE IF NOT EXISTS `et_portali_prodotti` (
...
--
-- Table structure for table `prpconversation`
--

CREATE TABLE IF NOT EXISTS `prpconversation` (
...
--
-- Table structure for table `rating_products_test`
--

CREATE TABLE IF NOT EXISTS `rating_products_test` (
  `rating_user_id` int(11) NOT NULL DEFAULT '0',
  `rating_r1` float(8,5) NOT NULL DEFAULT '0.00000',
  `rating_r2` float(8,5) NOT NULL DEFAULT '0.00000',
  `rating_r3` float(8,5) NOT NULL DEFAULT '0.00000',
...
--
-- Table structure for table `rating_products_test_20120924`
--

CREATE TABLE IF NOT EXISTS `rating_products_test_20120924` (
  `rating_user_id` int(11) NOT NULL DEFAULT '0',
  `rating_r1` float(8,5) NOT NULL DEFAULT '0.00000',
  `rating_r2` float(8,5) NOT NULL DEFAULT '0.00000',
  `rating_r3` float(8,5) NOT NULL DEFAULT '0.00000',
...
--
-- Table structure for table `rating_request_products`
--

CREATE TABLE IF NOT EXISTS `rating_request_products` (
...
--
-- Table structure for table `rating_request_products_20140203`
--

CREATE TABLE IF NOT EXISTS `rating_request_products_20140203` (
  `request_id` int(11) unsigned NOT NULL DEFAULT '0',
  `product` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`request_id`,`product`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `rating_test` (
  `rating_user_id` int(11) NOT NULL DEFAULT '0',
  `rating_r1` float(8,5) NOT NULL DEFAULT '0.00000',
  `rating_r2` float(8,5) NOT NULL DEFAULT '0.00000',
  `rating_r3` float(8,5) NOT NULL DEFAULT '0.00000',
...
--
-- Table structure for table `rating_test_20120924`
--

CREATE TABLE IF NOT EXISTS `rating_test_20120924` (
  `rating_user_id` int(11) NOT NULL DEFAULT '0',
  `rating_r1` float(8,5) NOT NULL DEFAULT '0.00000',
  `rating_r2` float(8,5) NOT NULL DEFAULT '0.00000',
  `rating_r3` float(8,5) NOT NULL DEFAULT '0.00000',
...
--
-- Table structure for table `request_assignment_reason`
--

CREATE TABLE IF NOT EXISTS `request_assignment_reason` (
...
--
-- Table structure for table `request_changelog`
--

CREATE TABLE IF NOT EXISTS `request_changelog` (
...
--
-- Table structure for table `tmpcronelab`
--

CREATE TABLE IF NOT EXISTS `tmpcronelab` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `usertypestorights`
--

CREATE TABLE IF NOT EXISTS `usertypestorights` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `user_assignments_20120605`
--

CREATE TABLE IF NOT EXISTS `user_assignments_20120605` (
  `user_id` int(11) NOT NULL,
  `lingua` varchar(10) NOT NULL,
  `n_reassigned` int(10) unsigned NOT NULL DEFAULT '0',
  `last_reassigned_date` datetime NOT NULL,
