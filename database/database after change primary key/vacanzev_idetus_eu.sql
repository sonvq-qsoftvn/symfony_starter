...
--
-- Table structure for table `allegati_v2`
--

CREATE TABLE IF NOT EXISTS `allegati_v2` (
...
--
-- Table structure for table `anagrafiche_contatti`
--
...
--
-- Table structure for table `anagrafiche_note`
--

CREATE TABLE IF NOT EXISTS `anagrafiche_note` (
...
--
-- Table structure for table `anagrafiche_v2_old`
--

CREATE TABLE IF NOT EXISTS `anagrafiche_v2_old` (
  `id_anagrafica` varchar(18) NOT NULL DEFAULT '',
...
--
-- Table structure for table `appalti_cliente_anagrafiche`
--

CREATE TABLE IF NOT EXISTS `appalti_cliente_anagrafiche` (
...
--
-- Table structure for table `appalti_cliente_messaggi`
--

CREATE TABLE IF NOT EXISTS `appalti_cliente_messaggi` (
  `id` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_appalto` int(6) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `appalti_cliente_testate`
--

CREATE TABLE IF NOT EXISTS `appalti_cliente_testate` (
...
--
-- Table structure for table `appalti_cliente_viaggi`
--

CREATE TABLE IF NOT EXISTS `appalti_cliente_viaggi` (
  `id_appalto` int(6) unsigned NOT NULL DEFAULT '0',
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `codiciaves`
--

CREATE TABLE IF NOT EXISTS `codiciaves` (
...
--
-- Table structure for table `codiciaves_rel_fornitori`
--

CREATE TABLE IF NOT EXISTS `codiciaves_rel_fornitori` (
...
--
-- Table structure for table `codicicontabili_rel_tiposervizi`
--

CREATE TABLE IF NOT EXISTS `codicicontabili_rel_tiposervizi` (
...
--
-- Table structure for table `documenti_contrattoviaggio`
--

CREATE TABLE IF NOT EXISTS `documenti_contrattoviaggio` (
...
--
-- Table structure for table `documenti_dettagliorichiesta`
--

CREATE TABLE IF NOT EXISTS `documenti_dettagliorichiesta` (
  `id` bigint(20) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `documenti_notaviaggio`
--

CREATE TABLE IF NOT EXISTS `documenti_notaviaggio` (
  `id` bigint(20) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `incassi_tipologie`
--

CREATE TABLE IF NOT EXISTS `incassi_tipologie` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `incentive_perc`
--

CREATE TABLE IF NOT EXISTS `incentive_perc` (
...
--
-- Table structure for table `incentive_perc2`
--

CREATE TABLE IF NOT EXISTS `incentive_perc2` (
  `codPromDest` int(10) unsigned NOT NULL DEFAULT '0',
  `codPromPart` int(10) unsigned NOT NULL DEFAULT '0',
  `data` varchar(6) NOT NULL DEFAULT '',
  `percorso` varchar(50) NOT NULL DEFAULT '',
...
--
-- Table structure for table `incentive_provvigioni`
--

CREATE TABLE IF NOT EXISTS `incentive_provvigioni` (
...
--
-- Table structure for table `incentive_scala`
--

CREATE TABLE IF NOT EXISTS `incentive_scala` (
...
--
-- Table structure for table `incentive_users`
--

CREATE TABLE IF NOT EXISTS `incentive_users` (
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `incentive_users_history`
--

CREATE TABLE IF NOT EXISTS `incentive_users_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `incentive_vp`
--

CREATE TABLE IF NOT EXISTS `incentive_vp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `incentive_vp2`
--

CREATE TABLE IF NOT EXISTS `incentive_vp2` (
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
  `gruppo` int(10) unsigned NOT NULL DEFAULT '0',
  `punti` decimal(8,2) unsigned NOT NULL DEFAULT '0.00',
  `fatturato` decimal(8,2) unsigned NOT NULL DEFAULT '0.00',
...
--
-- Table structure for table `moduli_notifiche_lettura`
--

CREATE TABLE IF NOT EXISTS `moduli_notifiche_lettura` (
  `id_modulo` int(6) unsigned NOT NULL DEFAULT '0',
  `tipoDocumento` tinyint(2) unsigned NOT NULL DEFAULT '0',
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `moduli_notifiche_lettura_old`
--

CREATE TABLE IF NOT EXISTS `moduli_notifiche_lettura_old` (
  `id_modulo` int(6) unsigned NOT NULL DEFAULT '0',
  `tipoDocumento` tinyint(2) unsigned NOT NULL DEFAULT '0',
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
  `dataLettura` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
--
-- Table structure for table `modulo_annullamentoto`
--

CREATE TABLE IF NOT EXISTS `modulo_annullamentoto` (
  `id_modulo` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
  `data` datetime DEFAULT '0000-00-00 00:00:00',
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `modulo_assicurazione`
--

CREATE TABLE IF NOT EXISTS `modulo_assicurazione` (
  `id_modulo` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
  `data` datetime DEFAULT '0000-00-00 00:00:00',
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `modulo_attesa_preventivo`
--

CREATE TABLE IF NOT EXISTS `modulo_attesa_preventivo` (
  `id_modulo` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
  `data` datetime DEFAULT '0000-00-00 00:00:00',
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `modulo_contratto_mail`
--

CREATE TABLE IF NOT EXISTS `modulo_contratto_mail` (
  `id_modulo` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
  `data` datetime DEFAULT '0000-00-00 00:00:00',
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `modulo_donazione`
--

CREATE TABLE IF NOT EXISTS `modulo_donazione` (
  `id_modulo` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
  `data` datetime DEFAULT '0000-00-00 00:00:00',
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `modulo_note`
--

CREATE TABLE IF NOT EXISTS `modulo_note` (
  `id_modulo` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
  `data` datetime DEFAULT '0000-00-00 00:00:00',
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `modulo_note_lotus`
--

CREATE TABLE IF NOT EXISTS `modulo_note_lotus` (
  `id_modulo` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
  `data` datetime DEFAULT '0000-00-00 00:00:00',
  `codPromotore` smallint(4) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `modulo_preventivo`
--

CREATE TABLE IF NOT EXISTS `modulo_preventivo` (
  `id_modulo` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
  `data` datetime DEFAULT '0000-00-00 00:00:00',
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `modulo_preventivo_modelli`
--

CREATE TABLE IF NOT EXISTS `modulo_preventivo_modelli` (
  `id` int(6) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `modulo_preventivo_modelli_new`
--

CREATE TABLE IF NOT EXISTS `modulo_preventivo_modelli_new` (
  `id` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_promotore` int(10) unsigned NOT NULL DEFAULT '0',
  `descrizione` varchar(50) NOT NULL DEFAULT '',
  `corpo` text NOT NULL,
...
--
-- Table structure for table `modulo_preventivo_new`
--

CREATE TABLE IF NOT EXISTS `modulo_preventivo_new` (
  `id_modulo` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
  `data` datetime DEFAULT '0000-00-00 00:00:00',
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `modulo_serviziweb`
--

CREATE TABLE IF NOT EXISTS `modulo_serviziweb` (
  `id_modulo` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
  `data` datetime DEFAULT '0000-00-00 00:00:00',
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `modulo_storno`
--

CREATE TABLE IF NOT EXISTS `modulo_storno` (
  `id_modulo` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
  `data` datetime DEFAULT '0000-00-00 00:00:00',
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `modulo_to`
--

CREATE TABLE IF NOT EXISTS `modulo_to` (
  `id_modulo` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
  `data` datetime DEFAULT '0000-00-00 00:00:00',
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `modulo_traghetto`
--

CREATE TABLE IF NOT EXISTS `modulo_traghetto` (
  `id_modulo` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
  `data` datetime DEFAULT '0000-00-00 00:00:00',
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `modulo_vololinea`
--

CREATE TABLE IF NOT EXISTS `modulo_vololinea` (
  `id_modulo` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
  `data` datetime DEFAULT '0000-00-00 00:00:00',
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `modulo_vololowcost`
--

CREATE TABLE IF NOT EXISTS `modulo_vololowcost` (
  `id_modulo` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
  `data` datetime DEFAULT '0000-00-00 00:00:00',
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `pagamenti_dettagli_campagne`
--

CREATE TABLE IF NOT EXISTS `pagamenti_dettagli_campagne` (
...
--
-- Table structure for table `pagamenti_dettagli_ebook`
--

CREATE TABLE IF NOT EXISTS `pagamenti_dettagli_ebook` (
  `idDettagli` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `pagamenti_dettagli_etgest`
--

CREATE TABLE IF NOT EXISTS `pagamenti_dettagli_etgest` (
  `idDettagli` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `pagamenti_dettagli_rinnovi`
--

CREATE TABLE IF NOT EXISTS `pagamenti_dettagli_rinnovi` (
  `idDettagli` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `idpromotore` int(10) unsigned NOT NULL DEFAULT '0',
  `idRif` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`idDettagli`)
...
--
-- Table structure for table `pagamenti_dettagli_servizi`
--

CREATE TABLE IF NOT EXISTS `pagamenti_dettagli_servizi` (
  `idDettagli` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `idpromotore` int(10) unsigned NOT NULL DEFAULT '0',
  `idRif` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`idDettagli`)
...
--
-- Table structure for table `pagamenti_metodi`
--

CREATE TABLE IF NOT EXISTS `pagamenti_metodi` (
...
--
-- Table structure for table `pag_bkps_richieste`
--

CREATE TABLE IF NOT EXISTS `pag_bkps_richieste` (
...
--
-- Table structure for table `pag_dettagli`
--

CREATE TABLE IF NOT EXISTS `pag_dettagli` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `pag_xpay_richieste`
--

CREATE TABLE IF NOT EXISTS `pag_xpay_richieste` (
...
--
-- Table structure for table `preventivi_attesa`
--

CREATE TABLE IF NOT EXISTS `preventivi_attesa` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` bigint(20) unsigned DEFAULT NULL,
  `codpromotore` int(10) unsigned DEFAULT NULL,
  `codpromotorecreazione` int(10) unsigned DEFAULT NULL,
...
--
-- Table structure for table `preventivi_temporanei`
--

CREATE TABLE IF NOT EXISTS `preventivi_temporanei` (
...
--
-- Table structure for table `preventivi_v2`
--

CREATE TABLE IF NOT EXISTS `preventivi_v2` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `id_viaggio` bigint(20) unsigned DEFAULT NULL,
  `codPromotore` int(10) unsigned DEFAULT NULL,
  `codPromotoreCreazione` int(10) unsigned DEFAULT NULL,
...
--
-- Table structure for table `preventivi_v2_md5`
--

CREATE TABLE IF NOT EXISTS `preventivi_v2_md5` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `preventivi_view`
--

CREATE TABLE IF NOT EXISTS `preventivi_view` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `provvigioni_20140704`
--

CREATE TABLE IF NOT EXISTS `provvigioni_20140704` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `codPromotore` int(10) unsigned NOT NULL DEFAULT '0',
  `provvigione` varchar(50) NOT NULL DEFAULT '',
  `id_viaggio` int(8) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `provvigioni_etraveler_punti`
--

CREATE TABLE IF NOT EXISTS `provvigioni_etraveler_punti` (
  `codPromotore` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `provvigioni_tipo`
--

CREATE TABLE IF NOT EXISTS `provvigioni_tipo` (
...
--
-- Table structure for table `provvigioni_tipo_sw`
--

CREATE TABLE IF NOT EXISTS `provvigioni_tipo_sw` (
  `nome` varchar(20) NOT NULL DEFAULT '',
  `percentuale` double NOT NULL DEFAULT '0',
  `ordine` tinyint(1) NOT NULL DEFAULT '0',
  `padre` varchar(20) NOT NULL DEFAULT '',
...
--
-- Table structure for table `salvataggio_temporanei`
--

CREATE TABLE IF NOT EXISTS `salvataggio_temporanei` (
...
--
-- Table structure for table `servizi_adeguamento`
--

CREATE TABLE IF NOT EXISTS `servizi_adeguamento` (
  `id` bigint(20) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `servizi_assicurazione`
--

CREATE TABLE IF NOT EXISTS `servizi_assicurazione` (
  `id` bigint(20) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `servizi_assicurazioneobbligatoria`
--

CREATE TABLE IF NOT EXISTS `servizi_assicurazioneobbligatoria` (
  `id` bigint(20) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `servizi_incasso`
--

CREATE TABLE IF NOT EXISTS `servizi_incasso` (
  `id` bigint(20) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `servizi_noleggio`
--

CREATE TABLE IF NOT EXISTS `servizi_noleggio` (
  `id` bigint(20) unsigned NOT NULL DEFAULT '0',
  `datain` date DEFAULT NULL,
...
--
-- Table structure for table `servizi_pacchetto`
--

CREATE TABLE IF NOT EXISTS `servizi_pacchetto` (
  `id` bigint(20) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `servizi_pax`
--

CREATE TABLE IF NOT EXISTS `servizi_pax` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `servizi_pax_relation`
--

CREATE TABLE IF NOT EXISTS `servizi_pax_relation` (
...
--
-- Table structure for table `servizi_prenotazione`
--
...
--
-- Table structure for table `servizi_terra`
--

CREATE TABLE IF NOT EXISTS `servizi_terra` (
  `id` bigint(20) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `servizi_traghetto`
--

CREATE TABLE IF NOT EXISTS `servizi_traghetto` (
  `id` bigint(20) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `servizi_vololinea`
--

CREATE TABLE IF NOT EXISTS `servizi_vololinea` (
  `id` bigint(20) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `servizi_vololowcost`
--

CREATE TABLE IF NOT EXISTS `servizi_vololowcost` (
  `id` bigint(20) unsigned NOT NULL DEFAULT '0',
  `numPrenotazione` varchar(100) DEFAULT NULL,
  `dataIN` date DEFAULT NULL,
  `partenza` char(3) DEFAULT NULL,
...
--
-- Table structure for table `tipo_passeggero`
--

CREATE TABLE IF NOT EXISTS `tipo_passeggero` (
...
--
-- Table structure for table `v1_codiciaves`
--

CREATE TABLE IF NOT EXISTS `v1_codiciaves` (
  `id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  `codiceAves` varchar(255) NOT NULL DEFAULT '',
  `iva` decimal(5,2) NOT NULL DEFAULT '0.00',
  `codice` varchar(20) NOT NULL DEFAULT '',
...
--
-- Table structure for table `viaggi_inconformita`
--

CREATE TABLE IF NOT EXISTS `viaggi_inconformita` (
